...
**Important note for Geant4 11.1.1 **: The DNA geometry was defined as being composed of DNA materials, for which the current public version of “molecularDNA” (release Geant4 11.1+patch01) does not include cross sections. 
