...
or dive into the documentation. 
 ...
 <span style="color:red">**Important** : This example is for demonstration purpose and acts as an introductory tool to help users create their own applications; therefore users are advised to adapt the parameters in their applications accordingly.</span>
